...
Mario.Character.prototype.Move = function() {
    ...
    this.sideWaysSpeed = Enjine.KeyboardInput.IsKeyDown(Enjine.Keys.A) ? 1.2 : 0.6;
...
Mario.Character.prototype.GetLarge = function() {
   return this.Large;
};

Mario.Character.prototype.GetFire = function() {
   return this.Fire;
};

Mario.Character.prototype.SetYJump = function(delta) {
   this.YJumpSpeed=-5.9;
   this.XJumpSpeed=-this.Facing*10;
   this.JumpBoost=3;
   
};

Mario.Character.prototype.GetYJumpSpeed = function() {
   return this.YJumpSpeed ;
};


Mario.Character.prototype.setSideWaysSpeed = function(delta) {
   this.sideWaysSpeed=delta;
};
Mario.Character.prototype.getSideWaysSpeed = function() {
